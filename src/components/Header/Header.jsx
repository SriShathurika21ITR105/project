    ...
    return (
        <header className='bg-white'>
                ...
                <div className="header-content">
                    <div className="header-left">
                        ...
                        <ul className='dekstop-nav list-unstyled m-0'>
                            ...
                            <li><button className='clean-button' onClick={() => { changeCategory("Kitchen") }}>Kitchen</button></li>
                            <li><button className='clean-button' onClick={() => { changeCategory("Bath") }}>Bath</button></li>
                            <li><button className='clean-button' onClick={() => { changeCategory("Outdoor") }}>Outdoor</button></li>
                            <li><button className='clean-button' onClick={() => { changeCategory("Lighting") }}>Lighting</button></li>
            ...
            <ul className={nav ? 'mobile-nav open-nav  list-unstyled m-0' : 'mobile-nav list-unstyled m-0'}>
                ...
                <li><button className='clean-button' onClick={() => { changeCategory("Kitchen"); closeHamburger() }}>Kitchen</button></li>
                <li><button className='clean-button' onClick={() => { changeCategory("Bath"); closeHamburger() }}>Bath</button></li>
                <li><button className='clean-button' onClick={() => { changeCategory("Outdoor"); closeHamburger() }}>Outdoor</button></li>
                <li><button className='clean-button' onClick={() => { changeCategory("Rugs & Decor"); closeHamburger() }}>Rugs & Decor</button></li>
                <li><button className='clean-button' onClick={() => { changeCategory("Lighting"); closeHamburger() }}>Lighting</button></li>                            
                {/* <li><button className='clean-button' onClick={() => { changeCategory("LoginPage") ;closeHamburger() }}>Login</button></li>
                <li><button className='clean-button' onClick={() => { changeCategory("SignPage") ;closeHamburger() }}>Signup</button></li> */}
